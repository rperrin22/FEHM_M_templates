...
zonefile=getfile('*material.zone');
...
sflr_interp = TriScatteredInterp(coor_sflr_3d(:,1),coor_sflr_3d(:,2),coor_sflr_3d(:,3)); %#ok<*DTRIINT>
...
dlmwrite('bob.dat',[depth porosity] ,'delimiter',',','precision','%.5f');
%Conductivity
%************
